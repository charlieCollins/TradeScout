...
### TODO File Management (GEMINI_TODO.md)
- We will use GEMINI_TODO.md to keep track of our tasks.
- I will help you keep it concise and forward-looking.
- We will remove completed tasks regularly to keep the file clean.
- Completed work can be documented in GEMINI_CONTEXT.md.
- The TODO file should be actionable and clean for our next session.
- I will help you sync TODOs to GEMINI_TODO.md to ensure session continuity.
