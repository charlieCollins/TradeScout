...
class MarketsManager:
    ...
    def _load_config(self) -> Dict:
        ...
        try:
            ...
            logger.info(f"Loaded markets config from {self.config_file}")
            return config
        ...
        for exchange_id, exchange_data in self.config["supported_exchanges"].items():
            try:
                ...
                market_hours = MarketHours(
                    ...
                    afterhours_start=self._parse_time(extended_hours["afterhours_start"]),
    ...
    def get_candidate_identification_markets(self) -> List[str]:
        ...
        candidate_config = self.config.get("market_categories", {}).get("candidate_identification", {})
    ...
    def get_current_trading_session(self, exchange_id: str = "nasdaq") -> TradingSession:
        """
    ...
    def is_after_hours_active(self, exchange_id: str = "nasdaq") -> bool:
        ...
        return self.get_current_trading_session(exchange_id) == TradingSession.AFTERHOURS
