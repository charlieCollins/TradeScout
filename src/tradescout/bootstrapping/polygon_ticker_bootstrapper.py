...
from ..data_models.models_base import Market, MarketType
    ...
    def _fetch_all_tickers(
        ...
        while True:
            ...
            if market_types:
                ...
                logger.info(f"Filtering by market types: {market_types} -> market={params['market']}")
        ...
        try:
            for ticker_data in tickers:
                try:
                    ...
                    if min_market_cap and ticker_data.get('market_cap', 0) < min_market_cap:
                    ...
                    cursor.execute("SELECT id FROM assets WHERE symbol = ?", (asset.symbol,))
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Bootstrap asset universe from Polygon.io')
    ...
    try:
        ...
        if args.stats_only:
            ...
            stats = bootstrapper.bootstrap_tickers(
                market_types=['stocks']
            )
